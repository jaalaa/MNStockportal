...
SECRET_KEY = 'django-insecure-)f8taua%az4pfeq+jya_z=40&!$0m^_2)@_r@t_o*aj%+@u_8z'
...
# stat add
import yaml
with open(os.path.join(BASE_DIR, 'env', 'dev.yaml')) as file:
